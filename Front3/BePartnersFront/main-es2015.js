...
const routes = [
    ...
    { path: 'products', component: _layout_layout_layout_component__WEBPACK_IMPORTED_MODULE_3__["LayoutComponent"], loadChildren: './modules/plan/planmodule.module#PlanModule' },
    {
        ...
        loadChildren: './modules/gestorconsulta/gestorconsulta.module#GestorConsultaModule'
    },
        ...
        if (token == "undefined" || token == null) {
            ...
            if (dateNow > dateToken) {
                ...
                if (localStorage.getItem('userSession') === null && localStorage.getItem('isLoggedIn') === 'true') {
                    ...
                    this.http.get(_domain_enums_urlpath__WEBPACK_IMPORTED_MODULE_8__["UrlPath"].URL_PATH + '/servicebroker/v1/public/catalog/profile/person/username/' + user.vEmail + '/').subscribe(response => {
                        let userSession = new _domain_models_profile_usersession_model__WEBPACK_IMPORTED_MODULE_9__["UserSession"]();
                        userSession = response.content;
                        /// Construction del Objeto
                        const userProfileRequest = new _domain_models_profile_profilerequest_model__WEBPACK_IMPORTED_MODULE_10__["ProfileRequest"]();
