...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_UpSert_Third`(
   IN v_Id_Third_Public varchar(80), IN V_Id_Type  varchar(80) , IN V_Identification_Number  varchar(80), IN V_Business_Name  varchar(80), IN V_Enable  char(1) )
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_UpSert_Third_Basic_Info`(
	 IN V_Id_Third_Public  varchar(80) , IN V_Id_Info_Type_Third  varchar(80),  IN V_Value  varchar(80),IN V_Enable  char(1) )
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_UpSert_User`(
	IN V_Id_User_Public  varchar(80) , IN V_Id_Type  varchar(80) , IN V_Identification_Number  varchar(80), IN V_Name  varchar(80), IN V_Last_Name  varchar(80) , IN V_Email  varchar(80), IN V_Phone  varchar(80), IN V_Profile_Picture  varchar(80),IN V_Enable  char(1) )
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_UpSert_User_Info`(
	 IN V_Id_User_Public  varchar(80) , IN V_Id_Info_Type_User  varchar(80),  IN V_Value  varchar(80), IN V_Enable  char(1) )
BEGIN
