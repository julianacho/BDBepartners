...
var isloginComponent = /** @class */ (function () {
    ...
    isloginComponent.prototype.ngOnInit = function () {
        ...
        if (this.Isloged) {
            var user_1 = new _domain_models_register_user_model__WEBPACK_IMPORTED_MODULE_5__["User"]();
            ...
            this.userSession.create(user_1)
...
var HeaderSessionComponent = /** @class */ (function () {
    ...
    HeaderSessionComponent.prototype.ngOnInit = function () {
        ...
        localStorage.getItem('isLoggedIn') === 'true' ? this.Isloged = true : this.Isloged = false;
        if (this.Isloged) {
            var user_1 = new _domain_models_register_user_model__WEBPACK_IMPORTED_MODULE_9__["User"]();
            user_1.vEmail = localStorage.getItem('currentUser');
            /*this.userSession.create(user).subscribe(response => {
                var userSession = new UserSession();
                userSession = response.content;
            ...
            this.userSession.create(user_1).subscribe(function (response) {
                ...
                sessionStorage.setItem('userProfileRequest', JSON.stringify(userProfileRequest));
                localStorage.setItem('photo', userSession.profilePicture);
                _this.userProfileRequest = JSON.parse(sessionStorage.getItem('userProfileRequest'));
                // tslint:disable-next-line:prefer-const
                var example = new _domain_models_example_RootObject__WEBPACK_IMPORTED_MODULE_4__["Example"]();
                _this.serviceExample.create(example).subscribe(function (userX) { return _this.mapUser(userX); });
                _this.profileBasic.sendRequest(_this.userProfileRequest).subscribe(function (responseX) { return _this.loadDataProfile(responseX); });
            });
        }
