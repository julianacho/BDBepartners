...
var LoginGuard = /** @class */ (function () {
    ...
    LoginGuard.prototype.canActivate = function (route, state) {
        ...
        if (token == "undefined" || token == null) {
            window.location.href = 'http://backsso-bepartners-dev.apps.appcanvas.net/sso/';
        }
        else {
            var decoded = jwt_decode__WEBPACK_IMPORTED_MODULE_2__(token);
            var dateToken = new Date(parseInt(decoded.exp, 10));
...
var CreateRegisterComponent = /** @class */ (function () {
    ...
    CreateRegisterComponent.prototype.confirmarContrasena = function () {
        // var sdfsdf=this.w.passwordUser.hasError('hasCapitalCase');
