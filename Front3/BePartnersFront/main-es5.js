...
var HeaderSessionComponent = /** @class */ (function () {
    ...
    HeaderSessionComponent.prototype.logout = function () {
        var _this = this;
        debugger;
        this.logOut.create(new _domain_models_logout_logout__WEBPACK_IMPORTED_MODULE_10__["LogOut"]).subscribe(function (param) { return _this.mapUserLogout(param); });
    };
