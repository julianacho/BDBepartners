...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(userSession, scrollSpyService, router) {
        this.userSession = userSession;
        this.scrollSpyService = scrollSpyService;
        this.router = router;
        this.sections = {};
    }
    HeaderComponent.prototype.userInSession = function () {
        this.userSession.create(new _domain_models_register_user_model__WEBPACK_IMPORTED_MODULE_4__["User"]()).subscribe(function (response) {
...
var HeaderSessionComponent = /** @class */ (function () {
    function HeaderSessionComponent(scrollSpyService, router, serviceExample, communication, profileBasic) {
        this.scrollSpyService = scrollSpyService;
        this.router = router;
    ...
    HeaderSessionComponent.prototype.mapUser = function (base) {
        var t = null;
        this.communication.updateTransaction(base);
    };
    HeaderSessionComponent.prototype.loadDataProfile = function (response) {
        this.communication.loadProfile(response);
    };
    HeaderSessionComponent.prototype.loadSessionProfile = function () {
        var userProfileRequest = new _domain_models_profile_profilerequest_model__WEBPACK_IMPORTED_MODULE_8__["ProfileRequest"]();
        var user = new _domain_models_register_user_model__WEBPACK_IMPORTED_MODULE_9__["User"]();
    ...
    HeaderSessionComponent.prototype.ngOnInit = function () {
        ...
        this.serviceExample.create(example).subscribe(function (user) { return _this.mapUser(user); });
        this.profileBasic.sendRequest(this.userProfileRequest).subscribe(function (response) { return _this.loadDataProfile(response); });
        if (this.router.url == '/index4') {
    ...
    HeaderSessionComponent.prototype.miGestor = function () {
...
var EditThirdComponent = /** @class */ (function (_super) {
    ...
    EditThirdComponent.prototype.processFile = function (imageInput) {
        ...
        reader.addEventListener('load', function (event) {
            ...
            _this.http.post(_domain_enums_urlpath__WEBPACK_IMPORTED_MODULE_24__["UrlPath"].URL_PATH + "/servicebroker/v1/private/catalog/profile/changeimageprofile/" + userSession.idUserPublic + '/', formData).subscribe(function (response) {
...
var IndicadorRiesgoComponent = /** @class */ (function () {
    ...
    IndicadorRiesgoComponent.prototype.loadSessionProfile = function () {
        var userProfileRequest = new _domain_models_profile_profilerequest_model__WEBPACK_IMPORTED_MODULE_5__["ProfileRequest"]();
        var user = new _domain_models_register_user_model__WEBPACK_IMPORTED_MODULE_6__["User"]();
        userProfileRequest.user = user;
...
module.exports = "@charset \"UTF-8\";\n.bg-register {\n  background: url('BackgroundFormularioRegistro.png');\n  background-repeat: no-repeat;\n  background-size: cover;\n  background-position: center;\n}\nform {\n  font-family: \"montserrat\", sans-serif;\n}\n.titles {\n  font-family: \"roboto\", sans-serif;\n  font-size: 23px;\n  text-align: left;\n}\n.content {\n  margin: 10px 40px 10px 25px;\n}\nimg {\n  margin-top: -14px;\n}\n.wrapper {\n  text-align: center;\n}\n.button {\n  position: absolute;\n  top: 50%;\n}\nh1 {\n  text-align: center;\n  font-family: \"Roboto\", sans-serif;\n}\nh3 {\n  text-align: center;\n}\nh2 {\n  text-align: center;\n}\n.imgTit {\n  display: block;\n  margin: auto;\n  height: 110px;\n}\nh4 {\n  text-align: center;\n  font-size: 12px;\n  margin: 20px 0px;\n}\naw-wizard.custom-step-css aw-wizard-navigation-bar.horizontal ul.steps-indicator li#customStep.current .label, aw-wizard.custom-step-css aw-wizard-navigation-bar.horizontal ul.steps-indicator li#customStep.editing .label {\n  color: violet;\n}\naw-wizard.custom-step-css aw-wizard-navigation-bar.horizontal ul.steps-indicator li#customStep.current .step-indicator, aw-wizard.custom-step-css aw-wizard-navigation-bar.horizontal ul.steps-indicator li#customStep.editing .step-indicator {\n  border-color: violet !important;\n  background-color: violet !important;\n}\naw-wizard.custom-step-css aw-wizard-navigation-bar.horizontal ul.steps-indicator li#customStep .label {\n  text-transform: lowercase;\n}\n.footer2 {\n  padding: 50px 0;\n  background-size: 100% 81%;\n  background-color: #3D3E3C;\n  font-family: \"montserrat\", sans-serif;\n  color: white;\n  padding-top: 0px;\n}\nbutton {\n  background-color: #B7BF10;\n  color: white;\n  font-weight: bolder;\n  width: 270px;\n}\na {\n  color: #00559C;\n}\nbutton:hover {\n  background-color: #D6DF0D;\n  color: white;\n}\n.textContraseña {\n  width: 400px;\n}\n.marginpasw {\n  padding-left: 52px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _domain_models_register_categoryrequest_model__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../../../domain/models/register/categoryrequest.model */ "./src/domain/models/register/categoryrequest.model.ts");
/* harmony import */ var _services_register_category_provider__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../services/register/category.provider */ "./src/client/app/services/register/category.provider.ts");
/* harmony import */ var _services_register_status_provider__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../services/register/status.provider */ "./src/client/app/services/register/status.provider.ts");
...
var CreateRegisterComponent = /** @class */ (function () {
    function CreateRegisterComponent(fb, fgPsw, serviceRegister, dialog, router, statusRegister, categoryService, spinner) {
        ...
        this.cityCategory = new _domain_models_register_categoryrequest_model__WEBPACK_IMPORTED_MODULE_16__["CategoryRequest"]();
        this.error = false;
        this.is_edit = true;
        /**Inicio Auto-complete*/
        this.formatter = function (x) { return x.nomHijo + ", " + x.nomPadre; };
        this.search = function (text$) { return text$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_15__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_15__["map"])(function (term) { return term === '' ? [] : _this.listCities.filter(function (v) { return v.nomHijo.toLowerCase().indexOf(term.toLowerCase()) > -1; }).slice(0, 10); })); };
        this.callCities();
    }
    CreateRegisterComponent.prototype.ngOnInit = function () {
        ...
        this.fgPswg = this.fgPsw.group({
            ...
            passwordUser: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            psw: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
    ...
    CreateRegisterComponent.prototype.mapUser = function (base) {
        ...
        if (base.status == "CONFLICT") {
            ...
            this.dialog.open(_Dialog_DialogComponent__WEBPACK_IMPORTED_MODULE_13__["DialogComponent"], { data: 3 }).afterClosed().subscribe(function (result) {
                _this.wizard.navigation.goToNextStep();
            });
        }
        else {
            ...
            if (ListUser == _domain_enums_Catalog_enum__WEBPACK_IMPORTED_MODULE_12__["Catalog"].ValueListasErrorConsulta) {
                ...
                // if (RuesThird == Catalog.ValueRuesInactivo || RuesThird == Catalog.ValueRuesSinResultado || RuesThird == Catalog.ValueRuesErrorConsulta) {
                //   this.spinner.hide();
                //   this.dialog
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", angular_archwizard__WEBPACK_IMPORTED_MODULE_19__["WizardComponent"])
    ...
    CreateRegisterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](5, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_services_register_status_provider__WEBPACK_IMPORTED_MODULE_18__["StatusToken"])),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](6, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_services_register_category_provider__WEBPACK_IMPORTED_MODULE_17__["CategoryToken"])),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], Object, _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialog"], _angular_router__WEBPACK_IMPORTED_MODULE_14__["Router"], Object, Object, ngx_spinner__WEBPACK_IMPORTED_MODULE_20__["NgxSpinnerService"]])
...
var UserSessionService = /** @class */ (function () {
    ...
    UserSessionService.prototype.create = function (values) {
        var request = this.http.get(_domain_enums_urlpath__WEBPACK_IMPORTED_MODULE_3__["UrlPath"].URL_PATH + "/servicebroker/v1/public/catalog/profile/person/username/prueba100003044362@gmail.com/");
        return request;
    };
