...
var GestorInformePrestaClicComponent = /** @class */ (function () {
    function GestorInformePrestaClicComponent(activePlanIRepository, prestaClicRequestService, dialog, comService) {
...
var CentroAyudaComponent = /** @class */ (function () {
    function CentroAyudaComponent() {
        this.tab1 = true;
        this.tab2 = false;
        this.tab3 = false;
    }
    CentroAyudaComponent.prototype.ngOnInit = function () {
    };
    CentroAyudaComponent.prototype.tabs = function (opt) {
        if (opt == 1) {
            this.tab1 = true;
            this.tab2 = false;
            this.tab3 = false;
...
var TerminosComponent = /** @class */ (function () {
    ...
    TerminosComponent.prototype.tabs = function (opt) {
        if (opt == 1) {
            this.tab1 = true;
            this.tab2 = false;
            this.tab3 = false;
...
var ConfirmationComponent = /** @class */ (function () {
    function ConfirmationComponent(http, router, activatedRoute, sendReference) {
        this.http = http;
        this.router = router;
        this.activatedRoute = activatedRoute;
    ...
    ConfirmationComponent.prototype.sendEmail = function () {
        var refItems = new _domain_models_plans_reqreferencepay_model__WEBPACK_IMPORTED_MODULE_7__["ReqReferencePay"]();
        ...
        this.sendReference.create(refItems).subscribe(function (response) {
        });
    };
...
var SumaryPlanComponent = /** @class */ (function () {
    ...
    SumaryPlanComponent.prototype.payPage = function () {
        ...
        this.payPlanToken.create(this.payModel).subscribe(function (response) {
            ...
            _this.redirectToPayU(payPlanModel);
        });
    };
    ...
    SumaryPlanComponent.prototype.redirectToPayU = function (payPlanModel) {
...
var EditThirdComponent = /** @class */ (function (_super) {
    ...
    function EditThirdComponent(profileBasic, profileBasicUpsert, categoryService, formBuilder, http, dialog, serviceRegister, comm) {
...
var FinantialStateComponent = /** @class */ (function () {
    ...
    FinantialStateComponent.prototype.upSertFinantialInfo = function () {
        ...
        this.finantialBasic.create(finantialModel).subscribe(function (response) {
            ...
            _this.communication.reloadComponent();
        });
    };
...
var IndicadorConfianzaComponent = /** @class */ (function () {
    function IndicadorConfianzaComponent(profilepercent, comm) {
        var _this = this;
        ...
        this.userSession = JSON.parse(sessionStorage.getItem('userSession'));
        this.comm.change.subscribe(function (relod) {
            _this.cargarPorcentaje();
        });
    }
    IndicadorConfianzaComponent.prototype.ngOnInit = function () {
        this.cargarPorcentaje();
    };
    IndicadorConfianzaComponent.prototype.cargarPorcentaje = function () {
        var _this = this;
...
var CreateRegisterComponent = /** @class */ (function () {
    function CreateRegisterComponent(fb, fgPsw, serviceRegister, dialog, router, statusRegister, categoryService, loadingScreenService) {
        var _this = this;
        this.fb = fb;
        this.fgPsw = fgPsw;
    ...
    CreateRegisterComponent.prototype.mapUser = function (base) {
        ...
        if (base.status === "CONFLICT") {
            ...
            this.dialog.open(_Dialog_DialogComponent__WEBPACK_IMPORTED_MODULE_13__["DialogComponent"], { data: 8 }).afterClosed().subscribe(function (result) {
                window.location.href = 'http://sso-bepartners-dev.apps.appcanvas.net/login';
            });
        }
        else if (base.status === 'ALREADY_REPORTED') {
            this.dialog.open(_Dialog_DialogComponent__WEBPACK_IMPORTED_MODULE_13__["DialogComponent"], { data: 9 }).afterClosed().subscribe(function (result) {
                window.location.href = 'http://sso-bepartners-dev.apps.appcanvas.net/login';
            });
        }
        else {
...
var ReferenceToken = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('reference.service');
var ReferenceProvider = /** @class */ (function () {
...
var ReferenceService = /** @class */ (function () {
    ...
    ReferenceService.prototype.create = function (value) {
...
var ReqReferencePay = /** @class */ (function () {
    function ReqReferencePay() {
    }
    return ReqReferencePay;
}());
...
//# sourceMappingURL=main-es5.3c6e319289f7d1c1bb6c.js.map