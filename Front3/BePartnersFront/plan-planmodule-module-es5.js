...
var SumaryPlanComponent = /** @class */ (function () {
    ...
    SumaryPlanComponent.prototype.redirectToPayU = function (signature) {
        ...
        this.pagoOnline.amount = 357617; //this.totalToPay;
        this.pagoOnline.tax = 57099; //this.iva;
        this.pagoOnline.taxReturnBase = 300518; //this.subTotal;
        this.pagoOnline.currency = 'COP';
        this.pagoOnline.signature = '85871f0624a995022c88cf57ca401ea9'; //signature;
    ...
    SumaryPlanComponent.prototype.payPage = function () {
        ...
        this.payPlanToken.create(this.payModel).subscribe(function (response) {
            ...
            _this.redirectToPayU(payPlanModel.signature);
            // e.target.submit();
