...
var ConfirmationComponent = /** @class */ (function () {
    ...
    ConfirmationComponent.prototype.loadParams = function () {
        ...
        this.activatedRoute.queryParams.subscribe(function (params) {
            _this.ApiKeypublic = '4Vj8eK4rloUd272L48hsrarnUA';
            _this.merchant_id = params['merchantId'];
            _this.referenceCode = params['referenceCode'];
            _this.TX_VALUE = params['TX_VALUE'];
            _this.currency = params['currency'];
            _this.transactionState = params['transactionState'];
            //this.firma_cadena = '$ApiKey~$merchant_id~$referenceCode~$New_value~$currency~$transactionState';
            // this.firmacreada = md5($firma_cadena);
            _this.firma = params['signature'];
            _this.reference_pol = params['reference_pol'];
            _this.cus = params['cus'];
            _this.extra1 = params['description'];
            _this.pseBank = params['pseBank'];
            _this.lapPaymentMethod = params['lapPaymentMethod'];
