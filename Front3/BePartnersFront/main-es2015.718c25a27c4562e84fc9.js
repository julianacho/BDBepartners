...
let EditThirdComponent = class EditThirdComponent extends _util_service_base_bean__WEBPACK_IMPORTED_MODULE_28__["ServiceBaseBean"] {
    constructor(profileBasic, profileBasicUpsert, categoryService, changePhotoService, http, formBuilder, spinner) {
        ...
        this.userSession = new _domain_models_profile_usersession_model__WEBPACK_IMPORTED_MODULE_26__["UserSession"]();
        this.third = new _domain_models_register_third_model__WEBPACK_IMPORTED_MODULE_4__["Third"]();
    ...
    processFile(imageInput) {
        ...
        reader.addEventListener('load', (event) => {
            ...
            this.http.post(_domain_enums_urlpath__WEBPACK_IMPORTED_MODULE_24__["UrlPath"].URL_PATH + `/servicebroker/v1/private/catalog/profile/changeimageprofile/` + this.userSession.idUserPublic + '/', formData).subscribe((response) => {
...
let ManageWelcomeComponent = class ManageWelcomeComponent {
    ...
    callData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            var decoded = jwt_decode__WEBPACK_IMPORTED_MODULE_7__(this.token);
            user.vEmail = decoded.sub;
            // tslint:disable-next-line:max-line-length
            yield this.http.get(_domain_enums_urlpath__WEBPACK_IMPORTED_MODULE_5__["UrlPath"].URL_PATH + '/servicebroker/v1/public/catalog/profile/person/username/' + user.vEmail + '/').toPromise().then(response => {
                //debugger
...
//# sourceMappingURL=main-es2015.718c25a27c4562e84fc9.js.map