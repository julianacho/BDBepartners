...
var PricingComponent = /** @class */ (function () {
    ...
    PricingComponent.prototype.loadPlans = function () {
        ...
        this.boPCPlanIRepository.create(request).subscribe(function (response) {
            ...
            _this.listBoPCPlan = [];
            _this.listBoPCPlan.push(_this.listBoPCPlanTemp[0]);
            _this.listBoPCPlan.push(_this.listBoPCPlanTemp[2]);
            _this.listBoPCPlan.push(_this.listBoPCPlanTemp[3]);
        });
    };
