...
var routes = [
    { path: 'gestorgndex', component: _index_index_component__WEBPACK_IMPORTED_MODULE_3__["IndexComponent"], canActivate: [_guards_login_guard__WEBPACK_IMPORTED_MODULE_4__["LoginGuard"]] }
];
...
var ConfirmationComponent = /** @class */ (function () {
    ...
    ConfirmationComponent.prototype.loadParams = function () {
        ...
        this.activatedRoute.queryParams.subscribe(function (params) {
            ...
            _this.http.post('https://default-bepartners-dev.apps.appcanvas.net/servicebroker/v1/public/transactionpay/payu/', 
            // tslint:disable-next-line:max-line-length
            {
...
var SumaryPlanComponent = /** @class */ (function () {
    ...
    SumaryPlanComponent.prototype.redirectToPayU = function (signature, idTransactionPublicReferenceCode) {
        ...
        this.pagoOnline.test = '1';
        this.pagoOnline.buyerEmail = 'bpalaciosa@gmail.com';
        this.pagoOnline.responseUrl = 'https://nginx-example-bepartners-dev.apps.appcanvas.net/payu/confirmation';
        this.pagoOnline.confirmationUrl = 'https://default-bepartners-dev.apps.appcanvas.net/servicebroker/v1/public/transactionpay/payu/';
...
var UrlPath = /** @class */ (function () {
    ...
    UrlPath.URL_PATH = 'https://default-bepartners-dev.apps.appcanvas.net';
    return UrlPath;
}());
