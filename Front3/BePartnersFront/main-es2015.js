...
let HeaderSessionComponent = class HeaderSessionComponent {
    constructor(scrollSpyService, router, serviceExample, communication, profileBasic, logOut) {
        this.scrollSpyService = scrollSpyService;
        this.router = router;
    ...
    loadSessionProfile() {
        let userProfileRequest = new _domain_models_profile_profilerequest_model__WEBPACK_IMPORTED_MODULE_9__["ProfileRequest"]();
        let user = new _domain_models_register_user_model__WEBPACK_IMPORTED_MODULE_11__["User"]();
